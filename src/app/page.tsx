            ...
            <div className="rounded-xl bg-white dark:bg-gray-800 shadow-xl transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              >
                ...
                <div className="mt-10 flex gap-4 justify-between">
                  <button onClick={loginwithgoogle} className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100 hover:bg-black">
                  ...
                  <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100 hover:bg-black hover:text-white">
                    <div className="relative flex items-center space-x-8 justify-center">
                      <svg
